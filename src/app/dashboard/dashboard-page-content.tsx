...
export const DashboardPageContent = () => {
  ...
  const { mutate: deletingCategory, isPending: isDeletingCategory } =
    useMutation({
      ...
      onSuccess: () => {
        {
          /* refresh the page by invalidating the queryKey */
        }
  ...
  return (
    <>
      <ul className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 max-w-6xl">
      ...
      {/* !! convert to a boolean or do it like Boolean(deleteCategory) */}
      <Modal
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm/6 text-gray-600">
              ...
              {deleteCategory}&quot;? This action cannot be undone.
            </p>
          </div>
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            <Button
              onClick={() => deleteCategory && deletingCategory(deleteCategory)}
              variant="destructive"
