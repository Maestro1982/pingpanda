...
export const CategoryEmptyState = ({
  ...
  const codeSnippet = `await fetch('https://pingpanda-mocha.vercel.app/api/events', {
  method: 'POST',
  headers: {
  ...
  return (
    <Card
      contentClassName="max-w-2xl flex flex-col w-full items-center p-6"
    ...
    >
      ...
      <div className="flex flex-col mt-8 items-center space-x-2">
